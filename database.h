...
public:
    ...
    DistanceType Distance(const std::string& stop1, const std::string& stop2) const;

    DistanceType LineDistance(const std::string& stop1, const std::string& stop2) const;
